...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isLogin) {
        // Login logic
        const res = await axios.post('https://sales-management-tool-backend.onrender.com/api/auth/login', {
        ...
        const loginRes = await axios.post('https://sales-management-tool-backend.onrender.com/api/auth/login', {
          email: formData.email,
          password: formData.password
        });
